...
<<tidy=FALSE, out.height="6.5in", out.width="8in", fig.width=8, fig.height=6.5>>==
  ...
  ggplot(unanimous,aes(x = congressNumber,y = value)) + 
    ...
    ggtitle(expression(atop("Number of Bills Resolved Unanimously Per Congress", atop(italic("Bills with 5 or Fewer Dissenting Votes")))))
@
\newpage
<<tidy=FALSE, out.height="6.5in", out.width="8in", fig.width=8, fig.height=6.5>>==
