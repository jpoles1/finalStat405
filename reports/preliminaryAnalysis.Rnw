...
<<echo=FALSE, out.height="4.5in", out.width="8in", fig.width=8, fig.height=4.5, cache=TRUE, warning=FALSE>>=
  ...
  aes(x = year, y = mean, group = 1, colour = 'Red') +
...
\href{}{fetchJSON.R} - This script contains the functions required to download data from the New York Times Congress and govtrack.org role-call vote APIs:
